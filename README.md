...
<br>-For normal user, just download the Textemage.exe from the release page (https://github.com/Akascape/TEXTEMAGE/releases/tag/Textemage.exe) and run the software and use.(The same python version is converted to .exe using Auto-py-to-exe Converter)
<br>
<br>►How to Use?
